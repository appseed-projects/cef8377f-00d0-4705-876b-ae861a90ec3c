...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-08-20 15:07`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/cef8377f-00d0-4705-876b-ae861a90ec3c.git
$ cd cef8377f-00d0-4705-876b-ae861a90ec3c
```
